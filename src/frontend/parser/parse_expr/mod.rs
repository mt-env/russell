...
pub(super) fn parse_expr(parser: &mut Parser) -> ParseResult<ParsedExpr> {
    parse_expr_prec(parser, Precedence::NotBinOp)
}

fn parse_expr_prec(parser: &mut Parser, min_prec: Precedence) -> ParseResult<ParsedExpr> {
...
fn parse_null_denotation(parser: &mut Parser) -> ParseResult<ParsedExpr> {
...
fn parse_atom_expr(parser: &mut Parser) -> ParseResult<ParsedExpr> {
    match parser.peek().kind() {
...
fn parse_unary_expr(parser: &mut Parser) -> ParseResult<ParsedExpr> {
...
fn parse_paren_expr(parser: &mut Parser) -> ParseResult<ParsedExpr> {
...
// fn ( <binding> ) -> <expr>
fn parse_closure_expr(parser: &mut Parser) -> ParseResult<ParsedExpr> {
...
fn parse_if_expr(parser: &mut Parser) -> ParseResult<ParsedExpr> {
...
fn parse_match_expr(parser: &mut Parser) -> ParseResult<ParsedExpr> {
...
// <left>( <expr>, ... )
fn parse_call_expr(parser: &mut Parser, left: ParsedExpr) -> ParseResult<ParsedExpr> {
    parser.expect(TokenKind::LParen)?;
...
fn parse_match_arms(parser: &mut Parser) -> ParseResult<Vec<(String, Vec<Binding>, ParsedExpr)>> {
